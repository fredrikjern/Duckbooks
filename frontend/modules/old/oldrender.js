export function renderPostLogin(username) {
...
export function renderLandinpage() {
  let messageContainer = document.querySelector(".message-container");
  messageContainer.innerHTML = `            
...
export function renderNavbar(username) {
  ...
  navbar.innerHTML = `
    <ul>
    <li>
    <button onclick="renderProfile()">My Profile</button>
    </li>
    <li>
...
function renderProfile() {
  let messageContainer = document.querySelector(".message-container");
  messageContainer.innerHTML = ` 
                        <h2> This is s Profile!! </h2>
                        <ul id="to-read-list"></ul>
                        <div>
                            Något
                        </div>
                        `;
  let toReadList = document.querySelector("#to-read-list");
}
